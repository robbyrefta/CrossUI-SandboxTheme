xui.Class('App', 'xui.Module',{
    Instance:{
        iniComponents : function(){
            ...
            host.xui_ui_panel3.append(
                ...
                .setValue("a")
                .onClickPanel("_xui_ui_buttonviews1_onclickpanel")
            );
    ...
    /**
         * Fired when user click the panel
         * @method onClickPanel [xui.UI.ButtonViews event]
         * @param {xui.UIProfile.} profile  The current control's profile object
         * @param {Object} item , item Object
         * @param {Event} e , Dom event object
         * @param {Element.xui} src  id or Dom Element
        */
    _xui_ui_buttonviews1_onclickpanel:function(profile, item, e, src){
